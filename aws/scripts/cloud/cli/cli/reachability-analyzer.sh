#!/bin/bash
# ------------------------------------------------------------------------------
# File       : reachability-analyzer.sh
# Purpose    : aws cloud/cli helper: reachability analyzer.
# Engine     : aws
# Category   : cloud/cli
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./reachability-analyzer.sh
# Parameters : DB_HOST_ENI, DB_HOST_IP, DEST_ID, DEST_PORT, NIA_ID, NI_PATH_ID, RDS_EP, STATUS, arg1, arg2, arg3
# Risk       : CHANGES
