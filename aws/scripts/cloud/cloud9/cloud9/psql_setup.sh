# ------------------------------------------------------------------------------
# File       : psql_setup.sh
# Purpose    : aws cloud/cloud9 helper: psql setup.
# Engine     : aws
# Category   : cloud/cloud9
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./psql_setup.sh
# Parameters : AWSREGION, CREDS, CreatedDate, DB14ENDP, DBENDP, DBPASS, DBUSER, PG14HOST, PGHOST, PGPASSWORD, PGUSER, SECRETARN
# Risk       : CHANGES
