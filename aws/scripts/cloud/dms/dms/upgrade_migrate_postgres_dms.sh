# ------------------------------------------------------------------------------
# File       : upgrade_migrate_postgres_dms.sh
# Purpose    : aws cloud/dms helper: upgrade migrate postgres dms.
# Engine     : aws
# Category   : cloud/dms
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./upgrade_migrate_postgres_dms.sh
# Parameters : EM365OHC4SFK666Y3JFWXGWP6MZ3CHCGQ5V6ZHQ, HBVG6NX2WLAIMEJSP44X6CI67YWGSNANQQHO64Y, LUI5N3XRZ5JJ6RZ2HHR4NOGAYTZWFORAVNJK3NA, aws, dms, endpoint, rep, text, us
# Risk       : DESTRUCTIVE
