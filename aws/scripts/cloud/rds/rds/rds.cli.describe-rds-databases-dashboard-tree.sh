#!/bin/bash
# ------------------------------------------------------------------------------
# File       : rds.cli.describe-rds-databases-dashboard-tree.sh
# Purpose    : aws cloud/rds helper: rds.cli.describe rds databases dashboard tree.
# Engine     : aws
# Category   : cloud/rds
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./rds.cli.describe-rds-databases-dashboard-tree.sh
# Parameters : DBInstanceIdentifier, Engine, EngineVersion, IsClusterWriter, Status
# Risk       : READ_ONLY
