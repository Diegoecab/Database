# ------------------------------------------------------------------------------
# File       : rds.cli.describe-orderable-db-instance-options.sh
# Purpose    : aws cloud/rds helper: rds.cli.describe orderable db instance options.
# Engine     : aws
# Category   : cloud/rds
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./rds.cli.describe-orderable-db-instance-options.sh
