# ------------------------------------------------------------------------------
# File       : rds.cli.createdb.postgres.sh
# Purpose    : aws cloud/rds helper: rds.cli.createdb.postgres.
# Engine     : aws
# Category   : cloud/rds
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./rds.cli.createdb.postgres.sh
# Parameters : AWSREGION, DBSECGRP, DBSUBNETGRP, EMROLE, EMROLEARN, RDSKMSKEY, RDSSTACK
# Risk       : CHANGES
