-- ------------------------------------------------------------------------------
-- File       : partitioned_table_create.sql
-- Purpose    : postgres storage helper: partitioned table create.
-- Engine     : postgres
-- Category   : storage
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: partitioned_table_create.sql
