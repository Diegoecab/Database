# ------------------------------------------------------------------------------
# File       : s3_export_import_steps.sh
# Purpose    : postgres backup_recovery helper: s3 export import steps.
# Engine     : postgres
# Category   : backup_recovery
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./s3_export_import_steps.sh
# Parameters : AbortMultipartUpload, AssumeRole, GetObject, ListBucket, PutObject, SourceAccount, SourceArn, aws, db, iam, pglab, policy, rds, role, s3, us
# Risk       : CHANGES
