-- ------------------------------------------------------------------------------
-- File       : postgres_lock_trees.sql
-- Purpose    : postgres diagnostics/sessions helper: postgres lock trees.
-- Engine     : postgres
-- Category   : diagnostics/sessions
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: postgres_lock_trees.sql
-- Parameters : int, interval, text
-- Risk       : READ_ONLY
