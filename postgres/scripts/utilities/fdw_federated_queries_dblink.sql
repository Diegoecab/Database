-- ------------------------------------------------------------------------------
-- File       : fdw_federated_queries_dblink.sql
-- Purpose    : postgres utilities helper: fdw federated queries dblink.
-- Engine     : postgres
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: fdw_federated_queries_dblink.sql
-- Parameters : text
-- Risk       : CHANGES
