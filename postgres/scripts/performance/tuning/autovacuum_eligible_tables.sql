-- ------------------------------------------------------------------------------
-- File       : autovacuum_eligible_tables.sql
-- Purpose    : postgres performance/tuning helper: autovacuum eligible tables.
-- Engine     : postgres
-- Category   : performance/tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: autovacuum_eligible_tables.sql
-- Parameters : float
-- Risk       : READ_ONLY
