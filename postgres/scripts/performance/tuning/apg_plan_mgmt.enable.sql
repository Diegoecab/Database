-- ------------------------------------------------------------------------------
-- File       : apg_plan_mgmt.enable.sql
-- Purpose    : postgres performance/tuning helper: apg plan mgmt.enable.
-- Engine     : postgres
-- Category   : performance/tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: apg_plan_mgmt.enable.sql
