-- ------------------------------------------------------------------------------
-- File       : 04_cbo_troubleshoot_save.sql
-- Purpose    : oracle/admin third_party helper: 04 cbo troubleshoot save.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: 04_cbo_troubleshoot_save.sql
-- Parameters : arg5488
-- Risk       : READ_ONLY
