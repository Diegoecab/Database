-- ------------------------------------------------------------------------------
-- File       : 02_badly_correlated.sql
-- Purpose    : oracle/admin third_party helper: 02 badly correlated.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: 02_badly_correlated.sql
