-- ------------------------------------------------------------------------------
-- File       : new_outer_join_and_or.sql
-- Purpose    : oracle/admin third_party helper: new outer join and or.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: new_outer_join_and_or.sql
-- Parameters : arg1, arg2, arg64
-- Risk       : DESTRUCTIVE
