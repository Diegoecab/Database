-- ------------------------------------------------------------------------------
-- File       : test_index_coalesce_candidate.sql
-- Purpose    : oracle/admin third_party helper: test index coalesce candidate.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: test_index_coalesce_candidate.sql
