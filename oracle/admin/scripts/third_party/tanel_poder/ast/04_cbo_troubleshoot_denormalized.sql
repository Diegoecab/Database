-- ------------------------------------------------------------------------------
-- File       : 04_cbo_troubleshoot_denormalized.sql
-- Purpose    : oracle/admin third_party helper: 04 cbo troubleshoot denormalized.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: 04_cbo_troubleshoot_denormalized.sql
-- Parameters : arg2, arg4
-- Risk       : READ_ONLY
