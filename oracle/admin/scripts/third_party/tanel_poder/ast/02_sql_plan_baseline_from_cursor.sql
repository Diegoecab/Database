-- ------------------------------------------------------------------------------
-- File       : 02_sql_plan_baseline_from_cursor.sql
-- Purpose    : oracle/admin third_party helper: 02 sql plan baseline from cursor.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: 02_sql_plan_baseline_from_cursor.sql
-- Parameters : bad_sqlid, good_plan_hash_value, good_sql_id, sql_handle_for_original
-- Risk       : CHANGES
