-- ------------------------------------------------------------------------------
-- File       : 04_cbo_troubleshoot_1.sql
-- Purpose    : oracle/admin third_party helper: 04 cbo troubleshoot 1.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: 04_cbo_troubleshoot_1.sql
