-- ------------------------------------------------------------------------------
-- File       : 04_cbo_troubleshoot_setup.sql
-- Purpose    : oracle/admin third_party helper: 04 cbo troubleshoot setup.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: 04_cbo_troubleshoot_setup.sql
-- Parameters : NO_INVALIDATE
-- Risk       : DESTRUCTIVE
