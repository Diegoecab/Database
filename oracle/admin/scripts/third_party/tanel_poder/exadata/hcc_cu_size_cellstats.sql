-- ------------------------------------------------------------------------------
-- File       : hcc_cu_size_cellstats.sql
-- Purpose    : oracle/admin third_party helper: hcc cu size cellstats.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: hcc_cu_size_cellstats.sql
