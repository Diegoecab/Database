-- ------------------------------------------------------------------------------
-- File       : setup_workload_index_control.sql
-- Purpose    : oracle/admin third_party helper: setup workload index control.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: setup_workload_index_control.sql
