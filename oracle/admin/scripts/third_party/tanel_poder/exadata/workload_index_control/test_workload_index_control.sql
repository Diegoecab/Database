-- ------------------------------------------------------------------------------
-- File       : test_workload_index_control.sql
-- Purpose    : oracle/admin third_party helper: test workload index control.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: test_workload_index_control.sql
