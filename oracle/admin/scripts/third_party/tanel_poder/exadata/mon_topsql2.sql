-- ------------------------------------------------------------------------------
-- File       : mon_topsql2.sql
-- Purpose    : oracle/admin third_party helper: mon topsql2.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: mon_topsql2.sql
-- Parameters : days, separator, weekdays
-- Risk       : READ_ONLY
