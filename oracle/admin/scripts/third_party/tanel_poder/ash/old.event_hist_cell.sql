-- ------------------------------------------------------------------------------
-- File       : old.event_hist_cell.sql
-- Purpose    : oracle/admin third_party helper: old.event hist cell.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: old.event_hist_cell.sql
