-- ------------------------------------------------------------------------------
-- File       : gen_ash_report_html.sql
-- Purpose    : oracle/admin third_party helper: gen ash report html.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: gen_ash_report_html.sql
-- Parameters : MI, _start, bdate, dbid, def_bdate, def_edate, edate, inst_id
-- Risk       : READ_ONLY
