-- ------------------------------------------------------------------------------
-- File       : gen_ash_report_text.sql
-- Purpose    : oracle/admin third_party helper: gen ash report text.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: gen_ash_report_text.sql
