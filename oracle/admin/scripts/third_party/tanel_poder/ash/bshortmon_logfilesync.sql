-- ------------------------------------------------------------------------------
-- File       : bshortmon_logfilesync.sql
-- Purpose    : oracle/admin third_party helper: bshortmon logfilesync.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: bshortmon_logfilesync.sql
