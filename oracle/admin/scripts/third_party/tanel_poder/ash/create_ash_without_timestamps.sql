-- ------------------------------------------------------------------------------
-- File       : create_ash_without_timestamps.sql
-- Purpose    : oracle/admin third_party helper: create ash without timestamps.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: create_ash_without_timestamps.sql
