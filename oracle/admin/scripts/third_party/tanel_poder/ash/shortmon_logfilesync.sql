-- ------------------------------------------------------------------------------
-- File       : shortmon_logfilesync.sql
-- Purpose    : oracle/admin third_party helper: shortmon logfilesync.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: shortmon_logfilesync.sql
