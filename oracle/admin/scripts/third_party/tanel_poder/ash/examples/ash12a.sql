-- ------------------------------------------------------------------------------
-- File       : ash12a.sql
-- Purpose    : oracle/admin third_party helper: ash12a.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: ash12a.sql
-- Parameters : FROM_TIME, IN_CONNECTION_MGMT, TO_TIME, cols, from_time, to_time
-- Risk       : READ_ONLY
