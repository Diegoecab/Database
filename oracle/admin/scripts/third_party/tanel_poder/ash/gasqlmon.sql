-- ------------------------------------------------------------------------------
-- File       : gasqlmon.sql
-- Purpose    : oracle/admin third_party helper: gasqlmon.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: gasqlmon.sql
...
-- @ash/gasqlmon ch5v0wxajrjzd 0 sysdate+(1/1440*-300)  sysdate
-- @ash/gasqlmon ch5v0wxajrjzd 0 sysdate-3  sysdate
