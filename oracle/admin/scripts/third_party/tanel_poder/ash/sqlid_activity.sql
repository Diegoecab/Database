-- ------------------------------------------------------------------------------
-- File       : sqlid_activity.sql
-- Purpose    : oracle/admin third_party helper: sqlid activity.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: sqlid_activity.sql
-- Parameters : MI, SS, bdate, dbid, def_bdate, def_edate, edate, inst_id, sqlid, sqlset_name
-- Risk       : READ_ONLY
