-- ------------------------------------------------------------------------------
-- File       : awr_sysmetric_history.sql
-- Purpose    : oracle/admin third_party helper: awr sysmetric history.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: awr_sysmetric_history.sql
