-- ------------------------------------------------------------------------------
-- File       : awr_sqlstats_per_exec.sql
-- Purpose    : oracle/admin third_party helper: awr sqlstats per exec.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: awr_sqlstats_per_exec.sql
