-- ------------------------------------------------------------------------------
-- File       : create_event_histogram_view.sql
-- Purpose    : oracle/admin third_party helper: create event histogram view.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: create_event_histogram_view.sql
