-- ------------------------------------------------------------------------------
-- File       : gen_awr_report.sql
-- Purpose    : oracle/admin third_party helper: gen awr report.
-- Engine     : oracle/admin
-- Category   : third_party
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: gen_awr_report.sql
-- Parameters : MI, SS, bid, dbid, eid
-- Risk       : READ_ONLY
...
SPOOL C:\Users\dcabrer2\Oracle\Scripts\awr_local_inst_1.html
SELECT * FROM TABLE(DBMS_WORKLOAD_REPOSITORY.AWR_GLOBAL_REPORT_HTML(:dbid, 1, &bid, &eid));
