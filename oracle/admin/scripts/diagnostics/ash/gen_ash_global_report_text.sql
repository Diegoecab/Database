-- ------------------------------------------------------------------------------
-- File       : gen_ash_global_report_text.sql
-- Purpose    : oracle/admin diagnostics/ash helper: gen ash global report text.
-- Engine     : oracle/admin
-- Category   : diagnostics/ash
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: gen_ash_global_report_text.sql
-- Parameters : MI, _start, bdate, dbid, def_bdate, def_edate, edate, sid, sqlid
-- Risk       : CHANGES
