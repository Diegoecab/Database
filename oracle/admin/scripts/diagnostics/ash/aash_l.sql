...
-- @ash/aash_l "TO_CHAR(sample_time,'DD-MM-YY,HH24')" 1=1 trunc(sysdate) sysdate
...
--     @ash/aash instance_number,TO_CHAR(sample_time,'DD-MM-YY,HH24') 1=1 to_date('02-11-20:08:00','DD-MM-YY:HH24:MI') to_date('02-11-20:20:00','DD-MM-YY:HH24:MI')
...
-- where status='CRITICAL' and to_char(BEGIN_INTERVAL_TIme,'HH24') like '0%';