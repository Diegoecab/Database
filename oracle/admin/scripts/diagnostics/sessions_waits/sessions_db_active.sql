-- ------------------------------------------------------------------------------
-- File       : sessions_db_active.sql
-- Purpose    : oracle/admin diagnostics/sessions_waits helper: sessions db active.
-- Engine     : oracle/admin
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: sessions_db_active.sql
-- Parameters : MI, SS
-- Risk       : DESTRUCTIVE
