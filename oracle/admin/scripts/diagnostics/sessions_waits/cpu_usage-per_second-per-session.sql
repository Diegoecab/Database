-- ------------------------------------------------------------------------------
-- File       : cpu_usage-per_second-per-session.sql
-- Purpose    : Oracle diagnostic query/report helper: cpu usage per second per session.
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @cpu_usage-per_second-per-session.sql
