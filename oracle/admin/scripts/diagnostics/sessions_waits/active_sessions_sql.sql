-- ------------------------------------------------------------------------------
-- File       : active_sessions_sql.sql
-- Purpose    : oracle/admin diagnostics/sessions_waits helper: active sessions sql.
-- Engine     : oracle/admin
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: active_sessions_sql.sql
