-- ------------------------------------------------------------------------------
-- File       : dbms_metadata.session_transform.sql
-- Purpose    : Oracle diagnostic query/report helper: dbms metadata session transform.
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dbms_metadata.session_transform.sql
