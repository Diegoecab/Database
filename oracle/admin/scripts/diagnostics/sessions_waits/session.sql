-- ------------------------------------------------------------------------------
-- File       : session.sql
-- Purpose    : oracle/admin diagnostics/sessions_waits helper: session.
-- Engine     : oracle/admin
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: session.sql
-- Parameters : MI, SS, sid, status, username
-- Risk       : DESTRUCTIVE
