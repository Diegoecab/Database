-- ------------------------------------------------------------------------------
-- File       : dba_hist_active_sess_history_pga.sql
-- Purpose    : Oracle diagnostic query/report helper: dba hist active sess history pga.
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_active_sess_history_pga.sql
