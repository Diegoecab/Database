-- ------------------------------------------------------------------------------
-- File       : DBA_HIST_ACTIVE_SESS_HISTORY_temp.sql
-- Purpose    : Oracle diagnostic query/report helper: DBA HIST ACTIVE SESS HISTORY temp.
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @DBA_HIST_ACTIVE_SESS_HISTORY_temp.sql
