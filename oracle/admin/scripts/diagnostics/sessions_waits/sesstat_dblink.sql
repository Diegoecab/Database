-- ------------------------------------------------------------------------------
-- File       : sesstat_dblink.sql
-- Purpose    : oracle/admin diagnostics/sessions_waits helper: sesstat dblink.
-- Engine     : oracle/admin
-- Category   : diagnostics/sessions_waits
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: sesstat_dblink.sql
