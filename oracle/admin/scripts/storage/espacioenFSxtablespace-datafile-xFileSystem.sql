-- ------------------------------------------------------------------------------
-- File       : espacioenFSxtablespace-datafile-xFileSystem.sql
-- Purpose    : Oracle storage, ASM, ACFS or tablespace helper: espacioenFSxtablespace datafile xFileSystem.
-- Category   : storage
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @espacioenFSxtablespace-datafile-xFileSystem.sql
