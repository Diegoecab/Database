-- ------------------------------------------------------------------------------
-- File       : asm_get_formatted_metadata.sql
-- Purpose    : Oracle storage, ASM, ACFS or tablespace helper: asm get formatted metadata(1).
-- Category   : storage
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @asm_get_formatted_metadata(1).sql
