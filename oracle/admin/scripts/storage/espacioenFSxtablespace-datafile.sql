-- ------------------------------------------------------------------------------
-- File       : espacioenFSxtablespace-datafile.sql
-- Purpose    : Oracle storage, ASM, ACFS or tablespace helper: espacioenFSxtablespace datafile.
-- Category   : storage
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @espacioenFSxtablespace-datafile.sql
