-- ------------------------------------------------------------------------------
-- File       : dba_hist_tbspc_space_tablespace_usage.sql
-- Purpose    : Oracle storage, ASM, ACFS or tablespace helper: dba hist tbspc space tablespace usage.
-- Category   : storage
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_tbspc_space_tablespace_usage.sql
