-- ------------------------------------------------------------------------------
-- File       : awsdms_support_collector_oracle.sql
-- Purpose    : AWS/RDS/DMS Oracle administration helper: awsdms support collector oracle.
-- Category   : cloud/aws
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @awsdms_support_collector_oracle.sql
...
prompt <li><a href="#DatabaseConfiguration14">Is GoldenGate enabled</a></li>
prompt </ol>
prompt </li>
...
prompt <li><a href="#TableDetails9">Compressed tables and partitions</a></li>
...
prompt <B>values of db memory component :</B><br>
...
-- New Minor heading and block :
prompt <p id="DatabaseConfiguration14"><h2>Is GoldenGate enabled :</h2></p>
prompt <li><a href="#DatabaseConfiguration13">previous : </a><a href="#Top">top : </a><a href="#SizeDetails1">next</a></li>
prompt To check whether GoldenGate is enabled on source db or not. As Oracle source with GG enabled having HCC compression would not be supported for prior DMS v3.5.<br><br>
prompt
prompt For additional details please see the following section of our documentation...<br>
prompt <a href="https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.Oracle.html">Using an Oracle database as a source for AWS DMS</a><br>
prompt Note : This sql may fail on pre 12C databases.<br><br>
...
-- New Minor heading and block :
prompt <p id="TableDetails9"><h2>Compressed tables and partitions :</h2></p>
prompt <li><a href="#TableDetails8">previous : </a><a href="#Top">top : </a><a href="#TableDetails10">next</a></li>
prompt The following shows any tables for schema &v_owner which have compression enabled.<br><br>
prompt
prompt Logminer and Binary Reader support different types of compression.<br>
prompt For additional details please see the following section of our documentation...<br>
...
prompt <br>
prompt The following contains the current session wait event and timing for the DMS user &v_connector. <br>
