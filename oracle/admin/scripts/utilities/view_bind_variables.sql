-- ------------------------------------------------------------------------------
-- File       : view_bind_variables.sql
-- Purpose    : oracle/admin utilities helper: view bind variables.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: view_bind_variables.sql
-- Parameters : SQLID, parsing_schema_name, plan_hash_value
-- Risk       : READ_ONLY
