-- ------------------------------------------------------------------------------
-- File       : streams_hc_10GR2.sql
-- Purpose    : Oracle administration helper: streams hc 10GR2.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @streams_hc_10GR2.sql
...
--If the number of files reported on "Registered Log Files For Capture" becomes very large, please consider modifying checkpoint_retention_time capture setting according to  
