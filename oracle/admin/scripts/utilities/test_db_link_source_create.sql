-- ------------------------------------------------------------------------------
-- File       : test_db_link_source_create.sql
-- Purpose    : oracle/admin utilities helper: test db link source create.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: test_db_link_source_create.sql
-- Parameters : CKEEP, DB_KEEP_CACHE_SIZE, EFLUSH, TBSDATA, TBSINDX, tbsdata, tbsindx
-- Risk       : CHANGES
