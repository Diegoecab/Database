-- ------------------------------------------------------------------------------
-- File       : SQLVersions10g.sql
-- Purpose    : Oracle administration helper: SQLVersions10g.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @SQLVersions10g.sql
...
col sql_text for a80 word_wrapped head "SQL"
col version_count for 999999 head "Versions"

--spool codeversions.out

select sql_id, sql_text, round(sharable_mem/1024/1024) sharable_mem_mb,version_count
from v$sqlstats
where version_count > 10
order by sharable_mem_mb asc,version_count asc
/
...
col s_text format a80 word_wrapped head "Object in Memory"
col s_id head "SQL ID"
col VERSIONS_VARIANCE format 999999999 head "Variance"
