-- ------------------------------------------------------------------------------
-- File       : dba_source_x_line.sql
-- Purpose    : Oracle administration helper: dba source x line.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_source_x_line.sql
...
accept LINEA prompt 'Ingrese Linea: '

select TEXT from dba_source where name= upper('&OBJ_NAME') and line = &LINEA order by line;
