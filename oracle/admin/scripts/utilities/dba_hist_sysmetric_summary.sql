-- ------------------------------------------------------------------------------
-- File       : dba_hist_sysmetric_summary.sql
-- Purpose    : Oracle administration helper: dba hist sysmetric summary.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_sysmetric_summary.sql
...
-- ------------------------------------------------------------------------------
--
--dba_hist_sysmetric_summary.sql
set lines 170
set pages 9999
