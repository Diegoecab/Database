...
# ------------------------------------------------------------------------------
# File       : addm_rep.sh
# Purpose    : oracle/admin utilities helper: addm rep.
# Engine     : oracle/admin
# Category   : utilities
...
# Version    : 1.0
# Usage      : ./addm_rep.sh
# Parameters : DEFVARIA, DIAS, FECHA, HOST, LEJEC, LOGF, MAIL, NOMBRE_BASE, ORACLE_SID, VAWR, arg1, arg2, arg3
# Risk       : READ_ONLY
...
database='$database'
LOGF=$FECHA"_reporte_addm"$ORACLE_SID".txt"
...
uuencode $LOGF $FECHA"_addm_"$HOST"_"$NOMBRE_BASE".html" | mailx -s "ADDM Base $HOST - $NOMBRE_BASE " $MAIL
