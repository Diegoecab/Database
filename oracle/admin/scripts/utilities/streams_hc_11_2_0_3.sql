-- ------------------------------------------------------------------------------
-- File       : streams_hc_11_2_0_3.sql
-- Purpose    : Oracle administration helper: streams hc 11 2 0 3.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @streams_hc_11_2_0_3.sql
...
--
REM
REM This healthcheck script is for use on Oracle11gR2 databases only.  (11.2.0.3)
REM 
REM
REM Do not use this script on Oracle9iR2 or Oracle 10g Streams configurations.
REM
...
REM  select * from system.logmnr_parameter$ order by session#,name;
...
from gv$xstream_table_stats group by  server_name;
...
sum(cdr_delete_row_exists),sum(cdr_delete_row_missing),
sum(cdr_successful_resolutions),sum(cdr_failed_resolutions),sum(cdr_successful_resolutions+cdr_failed_resolutions) cdr_total_resolutions
from gv$xstream_table_stats group by  server_name, server_id,source_table_owner,source_table_name,destination_table_owner,destination_table_name;
