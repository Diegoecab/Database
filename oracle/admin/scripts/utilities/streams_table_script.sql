-- ------------------------------------------------------------------------------
-- File       : streams_table_script.sql
-- Purpose    : Oracle administration helper: streams table script.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @streams_table_script.sql
...
CREATE TABLESPACE STREAMS_DATA datafile '/oradata/SARGPDE/data2/streams_data_01.dbf' size 25M;

CREATE USER STREAMS identified by STREAMS DEFAULT TABLESPACE STREAMS_DATA QUOTA UNLIMITED ON STREAMS_DATA;
...
GRANT EXECUTE ON DBMS_STREAMS TO streams;
...
GRANT DBA to streams;

exec DBMS_STREAMS_AUTH.GRANT_ADMIN_PRIVILEGE('STREAMS');
*/
...
-- 
-- Add supplemental log group for table "DBAS"."STREAMS_TABLE"
-- 
BEGIN 
  EXECUTE IMMEDIATE 'ALTER TABLE "DBAS"."STREAMS_TABLE" ADD SUPPLEMENTAL LOG DATA (PRIMARY KEY, FOREIGN KEY, UNIQUE INDEX) COLUMNS';
...
/
-- 
-- PROPAGATE changes for table "DBAS"."STREAMS_TABLE"
-- 
DECLARE 
...
/
-- 
-- CAPTURE changes for table "DBAS"."STREAMS_TABLE"
-- 
DECLARE 
  compat         VARCHAR2(512); 
  initpos        NUMBER; 
...
BEGIN
  ...
  object_name(1) := 'STREAMS_TABLE';
  object_owner := 'DBAS';
  FOR idx IN 1..1 LOOP
    SELECT COUNT(1) INTO cnt FROM all_tables@SARGPDE.GARBA.COM.AR
  ...
  dbms_datapump.add_file(
    handle=>h1,
    filename=>'streams_setup_2011_4_19_12_8_19_317.dmp',
    directory=>'ORA_EM_STRM_DPUMP_10205',
    filetype=>dbms_datapump.ku$_file_type_dump_file);
  dbms_datapump.add_file(
    handle=>h1,
    filename=>'streams_setup_2011_4_19_12_8_19_317.log',
    directory=>'ORA_EM_STRM_DPUMP_10205',
  ...
  dbms_file_transfer.put_file(
    ...
    source_file_name => 'streams_setup_2011_4_19_12_8_19_317.dmp', 
    destination_directory_object => '"ORA_EM_STRM_DPUMP_10205"', 
    destination_file_name => 'streams_setup_2011_4_19_12_8_19_317.dmp', 
...
/
-- 
-- APPLY changes for table "DBAS"."STREAMS_TABLE"
-- 
DECLARE 
  compat         VARCHAR2(512); 
  initpos        NUMBER; 
...
BEGIN 
DBMS_OUTPUT.PUT_LINE('*** Progress Message ===> Configured Subset Rule at the source database EXTTRDE.garba.com.ar for the capture process : null successfully. ***');
END; 
/
