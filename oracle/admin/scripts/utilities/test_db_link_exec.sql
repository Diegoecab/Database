-- ------------------------------------------------------------------------------
-- File       : test_db_link_exec.sql
-- Purpose    : oracle/admin utilities helper: test db link exec.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: test_db_link_exec.sql
-- Parameters : EFLUSH, IDENT, _connect_identifier, _date, _user, ext, mi, sep, spoolv, ss
-- Risk       : CHANGES
