-- ------------------------------------------------------------------------------
-- File       : get_db_information.sql
-- Purpose    : oracle/admin utilities helper: get db information.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: get_db_information.sql
-- Parameters : ALIGN, COLSPAN, CONTENT, EQUIV, MI, SS, White, absolute, auto, black, bold, dbname, hidden, mi, nbsp, nth, report_name, ss, suffix, timestamp, top
-- Risk       : CHANGES
