-- ------------------------------------------------------------------------------
-- File       : alert_log_table_create.sql
-- Purpose    : oracle/admin utilities helper: alert log table create.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: alert_log_table_create.sql
-- Parameters : MI, NLS_DATE_LANGUAGE, OWNER, SS, TBS, _DB, _bdump, alert_length
-- Risk       : DESTRUCTIVE
