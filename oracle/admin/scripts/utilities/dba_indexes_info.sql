-- ------------------------------------------------------------------------------
-- File       : dba_indexes_info.sql
-- Purpose    : Oracle administration helper: dba indexes info.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_indexes_info.sql
...
select i.owner, i.table_name, i.index_name, t.num_rows, round(bytes/1024/1024) Mb, t.blocks, i.clustering_factor,
