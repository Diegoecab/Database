-- ------------------------------------------------------------------------------
-- File       : segment_advisor.sql
-- Purpose    : Oracle administration helper: segment advisor.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @segment_advisor.sql
...
-- ------------------------------------------------------------------------------
--
/* Ejemplo de ejecución del Segment Advisor*/
...
taskdesc :='Obtener consejo de reducción según la tendencia de crecimiento del objeto';
numDaysToRetain :='1';
