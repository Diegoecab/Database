-- ------------------------------------------------------------------------------
-- File       : test_db_link_target_create.sql
-- Purpose    : oracle/admin utilities helper: test db link target create.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: test_db_link_target_create.sql
-- Parameters : BASE, PASSW
-- Risk       : CHANGES
