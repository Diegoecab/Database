-- ------------------------------------------------------------------------------
-- File       : dba_hist_pga_sga_stat_usage_hist.sql
-- Purpose    : Oracle administration helper: dba hist pga sga stat usage hist.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_pga_sga_stat_usage_hist.sql
