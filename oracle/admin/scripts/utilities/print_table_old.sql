-- ------------------------------------------------------------------------------
-- File       : print_table_old.sql
-- Purpose    : Oracle administration helper: print table old.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @print_table_old.sql
...
declare
    p_query varchar2(255):= '&1';
    p_date_fmt varchar2(50):= 'dd-mon-yyyy hh24:mi:ss' ;
