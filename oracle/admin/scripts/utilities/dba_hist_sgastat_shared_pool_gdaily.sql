-- ------------------------------------------------------------------------------
-- File       : dba_hist_sgastat_shared_pool_gdaily.sql
-- Purpose    : Oracle administration helper: dba hist sgastat shared pool gdaily.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_sgastat_shared_pool_gdaily.sql
...
-- ------------------------------------------------------------------------------
--
--dba_hist_sgastat_shared_pool_gdaily
REM  
...
select '"'||name||'"' n, to_date(to_char(begin_interval_time,'dd/mm/yyyy hh24'),'dd/mm/yyyy hh24')
begin_interval_time,
...
where pool='shared pool' and a.snap_id=b.snap_id and trunc (begin_interval_time) = trunc (sysdate)
