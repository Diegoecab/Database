-- ------------------------------------------------------------------------------
-- File       : verify_passwd.sql
-- Purpose    : Oracle administration helper: verify passwd.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @verify_passwd.sql
...
-- ------------------------------------------------------------------------------
--
CREATE OR REPLACE FUNCTION SYS.VERIFY_PASSWD (username varchar2, password varchar2, old_password varchar2)
RETURN boolean IS
   m integer;
   differ integer;
   isdigit boolean;
...
--      dbms_output.put_line (2);
      raise_application_error(-20003, 'Password should contain at least one numeric character');
    END IF;
