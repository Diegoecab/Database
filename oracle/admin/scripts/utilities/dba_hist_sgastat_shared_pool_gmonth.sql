-- ------------------------------------------------------------------------------
-- File       : dba_hist_sgastat_shared_pool_gmonth.sql
-- Purpose    : Oracle administration helper: dba hist sgastat shared pool gmonth.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_sgastat_shared_pool_gmonth.sql
