-- ------------------------------------------------------------------------------
-- File       : dba_hist_sysmetric_summary_cpu_io.sql
-- Purpose    : Oracle administration helper: dba hist sysmetric summary cpu io.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_sysmetric_summary_cpu_io.sql
