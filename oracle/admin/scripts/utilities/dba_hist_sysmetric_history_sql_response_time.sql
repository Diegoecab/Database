-- ------------------------------------------------------------------------------
-- File       : dba_hist_sysmetric_history_sql_response_time.sql
-- Purpose    : Oracle administration helper: dba hist sysmetric history sql response time.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_sysmetric_history_sql_response_time.sql
...
-- ------------------------------------------------------------------------------
--
--dba_hist_sysmetric_history_sql_response_time.sql
...
select to_char(begin_time,'dd-mm-yyyy hh24:mi') begin_time, value*100 , &_Average*100 avg_hist, &_standard_deviation stddev, round(value/&_standard_deviation,1) timesplusstddev
