-- ------------------------------------------------------------------------------
-- File       : sysmetric_history_sql_response_time.sql
-- Purpose    : Oracle administration helper: sysmetric history sql response time.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @sysmetric_history_sql_response_time.sql
