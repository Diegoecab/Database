-- ------------------------------------------------------------------------------
-- File       : desc_table_const.sql
-- Purpose    : oracle/admin utilities helper: desc table const.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: desc_table_const.sql
-- Parameters : OWNER, R_CONSTRAINT_NAME, TABLA, TABLE, TOWNER, TTABLE, towner, ttable
-- Risk       : READ_ONLY
