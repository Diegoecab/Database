-- ------------------------------------------------------------------------------
-- File       : decrease_data_files.sql
-- Purpose    : oracle/admin utilities helper: decrease data files.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: decrease_data_files.sql
-- Parameters : p_tablespace_name
-- Risk       : CHANGES
