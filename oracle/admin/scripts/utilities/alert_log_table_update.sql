-- ------------------------------------------------------------------------------
-- File       : alert_log_table_update.sql
-- Purpose    : oracle/admin utilities helper: alert log table update.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: alert_log_table_update.sql
-- Parameters : mi, ss
-- Risk       : CHANGES
