-- ------------------------------------------------------------------------------
-- File       : test_db_link_source_drop.sql
-- Purpose    : oracle/admin utilities helper: test db link source drop.
-- Engine     : oracle/admin
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: test_db_link_source_drop.sql
-- Parameters : CKEEP, DB_KEEP_CACHE_SIZE
-- Risk       : DESTRUCTIVE
