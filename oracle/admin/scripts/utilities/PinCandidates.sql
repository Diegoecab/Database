-- ------------------------------------------------------------------------------
-- File       : PinCandidates.sql
-- Purpose    : Oracle administration helper: PinCandidates.
-- Category   : utilities
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @PinCandidates.sql
...
col sharable_mem format 999999999 heading "Memory Used KB"
...
select owner, name, type, executions, round(sharable_mem/1024,1) sharable_mem
...
col sharable_mem format 999999999 heading "Memory Footprint"
col invalidations format 999999999 heading "Invalidations"
col loads format 999999999 heading "Loads"
