...
define reportHeader="<font size=+3 color=darkgreen><b>Snapshot Database 10<i>g</i></b></font><hr>Copyright (c) 1998-2007 Jeffrey M. Hunter. All rights reserved. (<a target=""_blank"" href=""http://www.idevelopment.info"">www.idevelopment.info</a>)<p>"
...
spool c:\tmp\&FileName._&_dbname._&_spool_time..html
...
COLUMN startup                    HEADING "Startup"            ENTMAP off
COLUMN parent_id                  HEADING "Parent|ID"          ENTMAP off
...
SELECT
  ...
  , '<div nowrap>' || modified || '</div>'                      modified
  , control
  , schema
  , procedure
  , startup
...
prompt <b><u>All RMAN Configuration Settings that are not default</u></b>
...
COLUMN keep_until             FORMAT a20                    HEADING 'Keep Until'             ENTMAP off
...
prompt <b><u>Available backup sets contained in the control file. Includes available and expired backup sets.</u></b>
...
SELECT
  ...
  , '<div align="right">' || bs.keep || '</div>'                                           keep
...
prompt <b><u>Available backup pieces contained in the control file. Includes available and expired backup sets.</u></b>
...
prompt <b><u>Available automatic SPFILE backups within all available (and expired) backup sets.</u></b>
