-- ------------------------------------------------------------------------------
-- File       : user_recrea.sql
-- Purpose    : oracle/admin security helper: user recrea.
-- Engine     : oracle/admin
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: user_recrea.sql
-- Parameters : direc, mi, ss, userid
-- Risk       : DESTRUCTIVE
