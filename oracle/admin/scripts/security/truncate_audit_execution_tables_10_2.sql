-- ------------------------------------------------------------------------------
-- File       : truncate_audit_execution_tables_10_2.sql
-- Purpose    : Oracle security, audit, user, role or grants helper: truncate audit execution tables 10 2.
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @truncate_audit_execution_tables_10_2.sql
