-- ------------------------------------------------------------------------------
-- File       : owb_runtime.wb_rt_audit_etl_udt_suc_4.sql
-- Purpose    : Oracle security, audit, user, role or grants helper: owb runtime wb rt audit etl udt suc 4.
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @owb_runtime.wb_rt_audit_etl_udt_suc_4.sql
