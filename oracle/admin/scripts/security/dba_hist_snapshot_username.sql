-- ------------------------------------------------------------------------------
-- File       : dba_hist_snapshot_username.sql
-- Purpose    : Oracle security, audit, user, role or grants helper: dba hist snapshot username.
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dba_hist_snapshot_username.sql
