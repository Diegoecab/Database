-- ------------------------------------------------------------------------------
-- File       : user_deps_obj_x.sql
-- Purpose    : oracle/admin security helper: user deps obj x.
-- Engine     : oracle/admin
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: user_deps_obj_x.sql
-- Parameters : OBJ, OWNER, owner
-- Risk       : READ_ONLY
