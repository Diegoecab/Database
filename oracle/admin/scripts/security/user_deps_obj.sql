-- ------------------------------------------------------------------------------
-- File       : user_deps_obj.sql
-- Purpose    : oracle/admin security helper: user deps obj.
-- Engine     : oracle/admin
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: user_deps_obj.sql
-- Parameters : owner
-- Risk       : READ_ONLY
...
REM ======================================================================
REM user_deps_obj.sql		Version 1.1	21 Marzo 2010
REM
REM Autor: 
REM Diego Cabrera
REM 
...
SELECT a.object_type, a.object_name, b.owner dep_owner, b.object_type dep_obj_type, b.object_name dep_obj_name,
 ...
 WHERE a.object_id = c.object_id
   ...
   and b.owner <> a.owner;
   --/* Dependencia de owner distinto al consultado */;
