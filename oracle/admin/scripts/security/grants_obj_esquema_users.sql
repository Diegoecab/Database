-- ------------------------------------------------------------------------------
-- File       : grants_obj_esquema_users.sql
-- Purpose    : oracle/admin security helper: grants obj esquema users.
-- Engine     : oracle/admin
-- Category   : security
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : Run with the target database client: grants_obj_esquema_users.sql
-- Parameters : SCHEMA
-- Risk       : CHANGES
