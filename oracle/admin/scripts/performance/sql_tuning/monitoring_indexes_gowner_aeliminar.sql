-- ------------------------------------------------------------------------------
-- File       : monitoring_indexes_gowner_aeliminar.sql
-- Purpose    : Oracle SQL performance and tuning helper: monitoring indexes gowner aeliminar.
-- Category   : performance/sql_tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @monitoring_indexes_gowner_aeliminar.sql
