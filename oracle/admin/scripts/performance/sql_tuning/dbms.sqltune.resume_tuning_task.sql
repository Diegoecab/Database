-- ------------------------------------------------------------------------------
-- File       : dbms.sqltune.resume_tuning_task.sql
-- Purpose    : Oracle SQL performance and tuning helper: dbms sqltune resume tuning task.
-- Category   : performance/sql_tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dbms.sqltune.resume_tuning_task.sql
