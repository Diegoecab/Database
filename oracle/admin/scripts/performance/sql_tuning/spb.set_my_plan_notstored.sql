-- ------------------------------------------------------------------------------
-- File       : spb.set_my_plan_notstored.sql
-- Purpose    : Oracle SQL performance and tuning helper: spb set my plan notstored.
-- Category   : performance/sql_tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @spb.set_my_plan_notstored.sql
