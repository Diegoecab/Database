-- ------------------------------------------------------------------------------
-- File       : dbms_stats_gather_table_stats_param.sql
-- Purpose    : Oracle SQL performance and tuning helper: dbms stats gather table stats param.
-- Category   : performance/sql_tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dbms_stats_gather_table_stats_param.sql
