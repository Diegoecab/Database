-- ------------------------------------------------------------------------------
-- File       : dbms_stats_toma_estadisticas_schedule_10g.sql
-- Purpose    : Oracle SQL performance and tuning helper: dbms stats toma estadisticas schedule 10g.
-- Category   : performance/sql_tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dbms_stats_toma_estadisticas_schedule_10g.sql
