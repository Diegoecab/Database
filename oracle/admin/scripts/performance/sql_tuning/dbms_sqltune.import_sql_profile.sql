-- ------------------------------------------------------------------------------
-- File       : dbms_sqltune.import_sql_profile.sql
-- Purpose    : Oracle SQL performance and tuning helper: dbms sqltune import sql profile.
-- Category   : performance/sql_tuning
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dbms_sqltune.import_sql_profile.sql
