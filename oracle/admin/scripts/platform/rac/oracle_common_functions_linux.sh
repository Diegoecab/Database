# ------------------------------------------------------------------------------
# File       : oracle_common_functions_linux.sh
# Purpose    : Oracle RAC or cluster administration helper: oracle common functions linux.
# Category   : platform/rac
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./oracle_common_functions_linux.sh
