SPO coe_xfr_sql_profile_djxz0dq464m6h_-1.log;
SET ECHO ON TERM ON LIN 2000 TRIMS ON NUMF 99999999999999999999;
REM
REM $Header: 215187.1 coe_xfr_sql_profile_djxz0dq464m6h_-1.sql 11.4.1.4 2021/09/29 csierra $
REM
...
REM
REM EXAMPLE
REM   SQL> START coe_xfr_sql_profile_djxz0dq464m6h_-1.sql;
REM
REM NOTES
...
REM      EXEC DBMS_SQLTUNE.DROP_SQL_PROFILE('coe_djxz0dq464m6h_-1');
