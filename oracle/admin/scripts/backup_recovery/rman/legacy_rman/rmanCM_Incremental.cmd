REM ------------------------------------------------------------------------------
REM File       : rmanCM_Incremental.cmd
REM Purpose    : Oracle RMAN backup, restore or recovery helper: rmanCM Incremental.
REM Category   : backup_recovery/rman
REM Author     : Diego Cabrera
REM Created    : Unknown
REM Version    : 1.0
REM Usage      : rmanCM_Incremental.cmd
...
rman target / catalog rman/catalog@catalog log=%dir_logs%\log_rman_incremental_%nombre_base%.log @D:\ORACLE\DBA\Scripts\incrementalCM.rman