REM ------------------------------------------------------------------------------
REM File       : ejcutaBKPInc.cmd
REM Purpose    : Oracle RMAN backup, restore or recovery helper: ejcutaBKPInc.
REM Category   : backup_recovery/rman
REM Author     : Diego Cabrera
REM Created    : Unknown
REM Version    : 1.0
REM Usage      : ejcutaBKPInc.cmd
...
rman target / @C:\rman\incremental.sql
