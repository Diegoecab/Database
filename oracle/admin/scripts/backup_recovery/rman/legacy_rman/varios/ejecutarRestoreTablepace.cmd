REM ------------------------------------------------------------------------------
REM File       : ejecutarRestoreTablepace.cmd
REM Purpose    : Oracle RMAN backup, restore or recovery helper: ejecutarRestoreTablepace.
REM Category   : backup_recovery/rman
REM Author     : Diego Cabrera
REM Created    : Unknown
REM Version    : 1.0
REM Usage      : ejecutarRestoreTablepace.cmd
...
rman @C:\rman\restoreTablespace.sql
