REM ------------------------------------------------------------------------------
REM File       : ExecControlF.bat
REM Purpose    : Oracle RMAN backup, restore or recovery helper: ExecControlF.
REM Category   : backup_recovery/rman
REM Author     : Diego Cabrera
REM Created    : Unknown
REM Version    : 1.0
REM Usage      : ExecControlF.bat
...
sqlplus / as sysdba @C:\BackupCM\RMAN\CPData\cStandByCtl.sql