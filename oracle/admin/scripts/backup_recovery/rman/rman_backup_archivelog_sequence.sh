# ------------------------------------------------------------------------------
# File       : rman_backup_archivelog_sequence.sh
# Purpose    : Oracle RMAN backup, restore or recovery helper: rman backup archivelog sequence.
# Category   : backup_recovery/rman
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./rman_backup_archivelog_sequence.sh
