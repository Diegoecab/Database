# ------------------------------------------------------------------------------
# File       : rman_restore_from_service_set_newname.sh
# Purpose    : Oracle RMAN backup, restore or recovery helper: rman restore from service set newname.
# Category   : backup_recovery/rman
# Author     : Diego Cabrera
# Created    : Unknown
# Version    : 1.0
# Usage      : ./rman_restore_from_service_set_newname.sh
