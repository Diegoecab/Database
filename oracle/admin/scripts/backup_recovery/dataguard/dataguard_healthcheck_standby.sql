-- ------------------------------------------------------------------------------
-- File       : dataguard_healthcheck_standby.sql
-- Purpose    : Oracle Data Guard administration helper: dataguard healthcheck standby.
-- Category   : backup_recovery/dataguard
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dataguard_healthcheck_standby.sql
...
-- ------------------------------------------------------------------------------
--
--dataguard_healthcheck_standby.sql
