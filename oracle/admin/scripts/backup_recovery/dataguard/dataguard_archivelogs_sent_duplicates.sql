-- ------------------------------------------------------------------------------
-- File       : dataguard_archivelogs_sent_duplicates.sql
-- Purpose    : Oracle Data Guard administration helper: dataguard archivelogs sent duplicates.
-- Category   : backup_recovery/dataguard
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dataguard_archivelogs_sent_duplicates.sql
