-- ------------------------------------------------------------------------------
-- File       : dataguard_healthcheck_primary.sql
-- Purpose    : Oracle Data Guard administration helper: dataguard healthcheck primary.
-- Category   : backup_recovery/dataguard
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dataguard_healthcheck_primary.sql
...
-- ------------------------------------------------------------------------------
--
--dataguard_healthcheck_primary.sql
