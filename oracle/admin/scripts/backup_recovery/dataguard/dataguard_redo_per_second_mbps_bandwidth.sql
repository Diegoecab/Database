-- ------------------------------------------------------------------------------
-- File       : dataguard_redo_per_second_mbps_bandwidth.sql
-- Purpose    : Oracle Data Guard administration helper: dataguard redo per second mbps bandwidth.
-- Category   : backup_recovery/dataguard
-- Author     : Diego Cabrera
-- Created    : Unknown
-- Version    : 1.0
-- Usage      : @dataguard_redo_per_second_mbps_bandwidth.sql
